...
<head>
    ...
    <title>SupcomJE - Register</title>

    <!-- Custom fonts for this template-->
    <link href="{{asset('../../../assets/vendors/fontawesome-free/all.min.css')}}" rel="stylesheet" type="text/css">
    <link
    ...
    <div class="container">
        <main class="py-4">
            <div class="row justify-content-center">
                ...
                <div style='margin-top:4%;' class="col-xl-10 col-lg-12 col-md-9">
