...
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <h2 class="title">Edit Data : Tasks 
            </h2>
            <div class="table-wrapper">
                <table class="fl-table">
                        ...
                        <tr>
                            <form method="POST" action="{{ route('admin.update.tasks', ['id' => $task->id]) }}">
                                @csrf
                                @method('PATCH')
                                <td><input type="text" name="title" value="{{ $task->title }}"></td>
                                <td><input type="text" name="description" value="{{ $task->description }}"></td>
                                <td><input style='width:6em;'type="text" name="priority" value="{{ $task->priority }}"></td>
                                <td><input type="text" name="date" value="{{ $task->date }}"></td>
                                <td><input style='width:4em;' type="text" name="duration" value="{{ $task->duration }}"></td>
                                <td>
