...
<body>
    ...
    <section id="content">
        ...
        <h2 class="title">Edit Data : Completion rate of scheduled tasks</h2>
        <div class="table-wrapper">
            <table class="fl-table">
                ...
                <tbody>
                    ...
                    <form method="POST" action="{{ route('admin.update.barchart', ['id' => $premier->id]) }}">
                        @csrf
                        @method('PATCH')
                        ...
                        <tr>
                            ...
                            <td> <input type="number" name="completed_on_time"
                                    value="{{ $premier->completed_on_time }}">
                            </td>
                            <td> <input type="number" name="total_tasks" value="{{ $premier->total_tasks }}">
                            </td>
                            <td>{{ $premier->created_at }}</td>
                            <td>{{ $premier->updated_at }}</td>
                            <td>
